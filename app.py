...
fire_model = YOLO(r"Open CV\runs\detect\ai_cctv9\weights\best.pt")
smoke_model= YOLO(r"Open CV\runs\detect\smoke_ai_detect5\weights\best.pt")
helmet_model= YOLO(r"Open CV\runs\detect\helmet_detect_ai2\weights\best.pt")
accident_model= YOLO(r"Open CV\runs\detect\model_car_accident\weights\best.pt")
